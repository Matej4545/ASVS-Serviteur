  ...
  return (
    <div className="">
      ...
      >
        ...
        <button
          className="border rounded-md w-fit px-2 mt-6 py-1 hover:bg-orange-600 hover:text-white transition mx-auto"
      ...
      >
        ...
        <textarea
          ...
          className="border rounded-sm p-1 min-w-24 min-h-48"
        />
        <input
          type="file"
          placeholder="Or select file"
          name="file"
